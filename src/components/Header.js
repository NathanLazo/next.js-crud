                                        ...
                                        <Menu as="div" className="ml-3 relative">
                                            ...
                                            >
                                                <Menu.Items className="z-50 origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                                                    ...
                                                    <Menu.Item>
                                                        {({ active }) => (
                                                            <button onClick={() => auth.signOut()} className={classNames(active ? 'bg-gray-100' : '', 'w-full block px-4 py-2 text-sm text-gray-700 text-left')}>
                                                                Sign out
                                                            </button>
                                                        )}
                                                    </Menu.Item>
                        ...
                        <Disclosure.Panel className="md:hidden">
                            ...
                            <div className="pt-4 pb-3 border-t border-gray-700">
                                ...
                                <div className="mt-3 px-2 space-y-1">
                                    ...
                                    <Disclosure.Button onMouseDown={() => auth.signOut()} as="a" className="block px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-700">
                                        Sign out
                                    </Disclosure.Button>
                                </div>
                            </div>
